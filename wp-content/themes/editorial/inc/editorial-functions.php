...
function editorial_admin_scripts_style( $hook ) {
	...
	wp_enqueue_script( 'editorial-admin-script', get_template_directory_uri() .'/inc/admin/js/admin-script.js', array('jquery'), '1.0.0', true );

	wp_enqueue_style( 'editorial-admin-style', get_template_directory_uri() .'/inc/admin/css/admin-style.css', '1.0.0' );
}
...
function editorial_scripts() {
	...
	wp_enqueue_style( 'editorial-style', get_stylesheet_uri() );
    
    wp_enqueue_style( 'editorial-responsive', get_template_directory_uri().'/css/editorial-responsive.css', array(), '1.0' );
	...
	if ( $menu_sticky_option != 'disable' ) {
          ...
          wp_enqueue_script( 'editorial-sticky-menu-setting', get_template_directory_uri(). '/js/sticky/sticky-setting.js', array( 'editorial-sticky-menu' ), '20150309', true );
    }

	wp_enqueue_script( 'editorial-custom-script', get_template_directory_uri() . '/js/custom-script.js', array( 'jquery-bxslider' ), '1.0.0', true );
...
/*------------------------------------------------------------------------------------------------*/
/**
 * Custom fucntion for wp_query args 
 */
...
/*------------------------------------------------------------------------------------------------*/
/**
 * Define function to show the social meida icons
 */
